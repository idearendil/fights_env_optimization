...
static int __pyx_f_8cythonfn_is_flippable(__Pyx_memviewslice __pyx_v_board_view, int __pyx_v_agent_id, int __pyx_v_r, int __pyx_v_c, int __pyx_v_board_size) {
  ...
  int __pyx_t_12;
  int __pyx_t_13;
  struct __pyx_opt_args_8cythonfn__check_in_range __pyx_t_14;
  int __pyx_t_15;
 ...
 */
      ...
      __pyx_t_14.bottom_right = __pyx_v_board_size;
      __pyx_t_13 = __pyx_f_8cythonfn__check_in_range(__pyx_v_now_r, __pyx_v_now_c, &__pyx_t_14); 
 ...
 *             elif board_view[agent_id, now_r, now_c]:
 */
      __pyx_t_16 = (1 - __pyx_v_agent_id);
      __pyx_t_17 = __pyx_v_now_r;
      __pyx_t_18 = __pyx_v_now_c;
      __pyx_t_15 = ((*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board_view.data + __pyx_t_16 * __pyx_v_board_view.strides[0]) ) + __pyx_t_17 * __pyx_v_board_view.strides[1]) ) + __pyx_t_18 * __pyx_v_board_view.strides[2]) ))) != 0);
      if (__pyx_t_15) {
 ...
 *                     return 1
 */
      __pyx_t_18 = __pyx_v_agent_id;
      __pyx_t_17 = __pyx_v_now_r;
      __pyx_t_16 = __pyx_v_now_c;
      __pyx_t_15 = ((*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board_view.data + __pyx_t_18 * __pyx_v_board_view.strides[0]) ) + __pyx_t_17 * __pyx_v_board_view.strides[1]) ) + __pyx_t_16 * __pyx_v_board_view.strides[2]) ))) != 0);
      if (__pyx_t_15) {
...
static int __pyx_f_8cythonfn__check_wins(__Pyx_memviewslice __pyx_v_board_view, int __pyx_v_board_size) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_agent0_cnt;
  int __pyx_v_agent1_cnt;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 *         for j in range(board_size):
 */
  __pyx_v_agent0_cnt = 0;
  __pyx_v_agent1_cnt = 0;
 ...
 *                 agent1_cnt += 1
 */
        __pyx_v_agent0_cnt = (__pyx_v_agent0_cnt + 1);
 ...
 *         return 1
 */
        __pyx_v_agent1_cnt = (__pyx_v_agent1_cnt + 1);
 ...
 */
  __pyx_t_10 = ((__pyx_v_agent0_cnt > __pyx_v_agent1_cnt) != 0);
  if (__pyx_t_10) {
